...
fun ImageView.loadImage(urlImage: File, @DrawableRes placeHolder: Int, isCircle: Boolean = false) {
    if (isCircle) {
        Glide.with(this)
            .load(urlImage)
            .circleCrop()
...
fun ImageView.loadImage(urlImage: Uri?, @DrawableRes placeHolder: Int, isCircle: Boolean = false) {
    if (isCircle) {
        Glide.with(this)
            .load(urlImage)
            .circleCrop()
